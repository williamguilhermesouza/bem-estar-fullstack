    ...
    <form method="POST" action={{route('admin.patient.save')}}>
        ...
        <div class="form-row">
            ...
            <div class="col">
                ...
                <input name="streetNumber" type="number" id="streetNumber" class="form-control"/>
            </div>
            <div class="col">
                <label for="streetDistrict">Bairro</label>
                <input name="streetDistrict" id="streetDistrict" class="form-control"/>
            </div>
        </div>
        <div class="form-row">
            <div class="col">
        ...
        <div class="form-row">
            ...
            <div class="col">
                ...
                <input name="placeOfBirth" id="placeOfBirth" class="form-control"/>
            </div>
            <div class="col-md-2">
